 ...
 * {@link com.sbm.sevenroomstohub.domain.Venue}.
 */
@Service
@Transactional
public class VenueServiceImpl implements VenueService {
    ...
    public Optional<Venue> findByVenueId(String venueId) {
        log.debug("Request to get Client by Id : {}", venueId);
    ...
    @Override
    public Venue save(Venue venuePayload) {
        log.debug("Request to save Venue : {}", venuePayload);
        return venueRepository.save(venuePayload);
    }
}
