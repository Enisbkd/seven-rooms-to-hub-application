...
public class Venue implements Serializable {
    ...
    @Column(name = "venud_id")
    private String venudId;
    ...
    public String getVenudId() {
        return this.venudId;
    }

    public Venue venudId(String venudId) {
        this.setVenudId(venudId);
        return this;
    }

    public void setVenudId(String venudId) {
        this.venudId = venudId;
    }
