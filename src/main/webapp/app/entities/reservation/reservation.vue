      ...
      <table class="table table-striped" aria-describedby="reservations">
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('venueSeatingAreaId')">
              <span v-text="t$('sevenRoomsToHubApplicationApp.reservation.venueSeatingAreaId')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'venueSeatingAreaId'"></jhi-sort-indicator>
            </th>
            <th scope="row" v-on:click="changeOrder('venueSeatingAreaName')">
              <span v-text="t$('sevenRoomsToHubApplicationApp.reservation.venueSeatingAreaName')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'venueSeatingAreaName'"></jhi-sort-indicator>
            </th>
            ...
            <th scope="row" v-on:click="changeOrder('iswalkin')">
              <span v-text="t$('sevenRoomsToHubApplicationApp.reservation.iswalkin')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'iswalkin'"></jhi-sort-indicator>
            </th>
