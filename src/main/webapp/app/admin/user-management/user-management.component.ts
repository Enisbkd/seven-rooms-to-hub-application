      ...
      this.userManagementService
        ...
        .then(res => {
          this.alertService.showInfo(
            this.t$(res.headers['x-sevenroomstohubapplicationapp-alert'].toString(), {
              param: decodeURIComponent(res.headers['x-sevenroomstohubapplicationapp-params'].replace(/\+/g, ' ')),
            }),
            { variant: 'danger' },
          );
          this.removeId = null;
