...
public class ReservationTestSamples {
    ...
    public static Reservation getReservationSample1() {
        return new Reservation()
            ...
            .venueSeatingAreaId("venueSeatingAreaId1")
            .venueSeatingAreaName("venueSeatingAreaName1")
    ...
    public static Reservation getReservationSample2() {
        return new Reservation()
            ...
            .venueSeatingAreaId("venueSeatingAreaId2")
            .venueSeatingAreaName("venueSeatingAreaName2")
    ...
    public static Reservation getReservationRandomSampleGenerator() {
        return new Reservation()
            ...
            .venueSeatingAreaId(UUID.randomUUID().toString())
            .venueSeatingAreaName(UUID.randomUUID().toString())
