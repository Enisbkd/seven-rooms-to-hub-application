...
class VenueResourceIT {
    ...
    private static final String DEFAULT_VENUD_ID = "AAAAAAAAAA";
    private static final String UPDATED_VENUD_ID = "BBBBBBBBBB";
    ...
    void createVenue() throws Exception {
        ...
        assertThat(testVenue.getVenudId()).isEqualTo(DEFAULT_VENUD_ID);
    ...
    void getAllVenues() throws Exception {
        ...
        restVenueMockMvc
            ...
            .andExpect(jsonPath("$.[*].venudId").value(hasItem(DEFAULT_VENUD_ID)))
    ...
    void getVenue() throws Exception {
        ...
        restVenueMockMvc
            ...
            .andExpect(jsonPath("$.venudId").value(DEFAULT_VENUD_ID))
    ...
    void putExistingVenue() throws Exception {
        ...
        assertThat(testVenue.getVenudId()).isEqualTo(UPDATED_VENUD_ID);
